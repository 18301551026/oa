...
<body>
	<div class="panel panel-info">
		...
		<div class="panel-body hide" id="queryPanel">
			<form role="form" id="queryForm" class="form-horizontal"
				action="${ctx}/person/draftBox!findPage.action" method="post">
	...
	<form method="post" action="${ctx }/person/draftBox!delete.action"
		id="deleteForm">
			...
			<tbody>
				<s:iterator value="#page.result">
					<tr>
						...
						<td>${createDate }</td>
						<Td><a href="${ctx}/person/draftBox!toUpdate.action?id=${id}">编辑</a>
						</Td>
					</tr>
				</s:iterator>
			</tbody>
