...
<body class="editBody">
	...
	<div class="btn-group pull-right btn-group-sm">
		...
		<button type="button" class="btn btn-info" id="resetButton"
			actionUrl='${ctx }/work/module!toUpdate.action?id=${id}'>
		...
		<table class="formTable table">
			...
			<Tr>
				...
				<Td class="query_input" colspan="3"><s:textfield
						...
						readonly="true" cssStyle="width:95%" placeholder="请选择可见人员"></s:textfield>
					<input class="btn btn-info btn-xs pull-right" value="选择"
					id="selectCanWatchUsersButton" actionId='${id }' type="button" /></Td>
			</Tr>
			<Tr>
