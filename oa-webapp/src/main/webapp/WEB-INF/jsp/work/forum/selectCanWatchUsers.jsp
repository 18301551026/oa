...
<body>
	<script type="text/javascript" src="${ctx }/js/forum-selectCanWatchUsers.js"></script>
	<div class="easyui-layout" data-options="fit:true,border:false">
		<s:hidden id="ids" name="receiveUserIds"  value="%{canWatchUserIds}"></s:hidden>
		<s:hidden name="receiveUsersName" id="receiveUsersName" value="%{canWathUserNames}"></s:hidden>
