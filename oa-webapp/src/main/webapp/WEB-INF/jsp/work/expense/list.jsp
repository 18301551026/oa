	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="btn-group btn-group-sm">
				<button id="addButton" class="btn btn-info"
					actionUrl="${ctx }/work/expense!toAdd.action">
					<span class="glyphicon glyphicon-plus"></span> 新建
				</button>
				<button id="startButton" class="btn btn-info"
					actionUrl="${ctx }/work/expense!start.action">
		...
		<div class="panel-body hide" id="queryPanel">
			<form role="form" id="queryForm" class="form-horizontal"
				action="${ctx}/work/expense!findPage.action" method="post">
