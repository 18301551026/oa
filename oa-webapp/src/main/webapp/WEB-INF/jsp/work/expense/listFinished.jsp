	...
	<div class="panel panel-info">
		...
		<div class="panel-body hide" id="queryPanel">
			<form role="form" id="queryForm" class="form-horizontal"
				action="${ctx}/work/expenseFinished!findPage.action" method="post">
			...
			<tbody>
				<s:iterator value="#page.result">
					<tr>
						...
						<td>${title }</td>
						<td><a
							href="${ctx }/work/expenseFinished!watch.action?id=${id}&definitionKey=<s:property value='@ com.lxs.process.common.ProcessEnum@expense'/>">查看</a>
						</td>
					</tr>
				</s:iterator>
			</tbody>
