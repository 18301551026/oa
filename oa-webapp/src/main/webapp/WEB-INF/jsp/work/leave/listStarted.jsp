	...
	<div class="panel panel-info">
		...
		<div class="panel-body hide" id="queryPanel">
			<form role="form" id="queryForm" class="form-horizontal"
				action="${ctx}/work/leave!leaveStarted!findPage.action"
				method="post">
			...
			<tbody>
				<s:iterator value="#page.result">
					<tr>
						...
						<td>${title }</td>
						<td><a
							href="${ctx }/process/instance!watch.action?id=${id}&definitionKey=<s:property value="@ com.lxs.process.common.ProcessEnum@leave"/>">流程跟踪</a>
						</td>
					</tr>
				</s:iterator>
			</tbody>
