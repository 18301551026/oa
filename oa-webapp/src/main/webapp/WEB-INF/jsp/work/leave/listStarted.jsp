...
<body>
	...
	<div id="queryDiv">
	<form id="queryForm" class="form-horizontal" action="${ctx}/work/leave!leaveStarted!findPage.action" method="post">
		<fieldset>
    ...
    <table width="100%" >
	  ...
	  <tbody>
		  ...
		  <td>${title }</td>
          <td>
           	<a href="${ctx }/process/instance!watch.action?id=${id}&definitionKey=<s:property value="@ com.lxs.process.common.ProcessEnum@leave"/>">流程跟踪</a>
		  </td>
	    </tr>
