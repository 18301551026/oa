...
<body>
	<form id="editForm" class="form-horizontal" action="${ctx}/work/leave!performTask.action" method="post">
	...
	<div id="editDiv">
		<fieldset>
		<legend><small>执行请假任务</small></legend>
		<table >
		  <tr>
			...
			<tr>				
				...
				<td colspan="3">
					<s:textfield name="title" readonly="true"></s:textfield>
				</td>
			</tr>
			<tr>				
