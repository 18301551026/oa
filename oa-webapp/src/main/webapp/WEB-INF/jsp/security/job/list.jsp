...
<body>
	<div id="navigatorDiv">
	  	<button type="button" id="addButton" class="button positive" actionUrl="${ctx }/security/job!toAdd.action">
	...
	<div id="queryDiv">
	<form id="queryForm" class="form-horizontal" action="${ctx}/security/job!findPage.action" method="post">
		<fieldset>
		<legend><small>职位查询</small></legend>
		<table >
			<tr>
				<td width="20%"><label>职位名称：</label></td>
				<td>
  ...
  <form id="deleteForm" action="${ctx }/security/job!delete.action">
