...
<body>
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="btn-group btn-group-sm">
				<button id="addButton"
					actionUrl="${ctx }/message/notice!toAdd.action"
					class="btn btn-info">
		...
		<div class="panel-body hide" id="queryPanel">
			<form role="form" id="queryForm" class="form-horizontal"
				action="${ctx}/message/notice!findPage.action" method="post">
				<table class="formTable">
					<Tr>
						<Td class="control-label"><label for="type">类型：</label></Td>
						<Td class="query_input"><s:select cssClass="form-control"
								id="type" list="dictionarys" listKey="name" listValue="value"
								headerKey="" headerValue="全部" name="type"></s:select></Td>
	...
	<form method="post" action="${ctx }/message/notice!delete.action"
		id="deleteForm">
			...
			<tbody>
				<s:iterator value="#page.result">
					<tr>
						...
						<td>${type}</td>
						<td>${title }</td>
						<td><a href="${ctx}/message/notice!toUpdate.action?id=${id}">修改</a></td>
					</tr>
				</s:iterator>
			</tbody>
		</table>
