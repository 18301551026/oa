...
<body>
	...
	<div id="navigatorDiv">
	  	<button type="button" id="addButton" class="button positive" actionUrl="${ctx }/message/notice!toAdd.action">
	...
	<div id="queryDiv">
	<form id="queryForm" class="form-horizontal" action="${ctx}/message/notice!findPage.action" method="post">
		<fieldset>
  ...
  <form id="deleteForm" action="${ctx }/message/notice!delete.action">
