...
public class RoleAction extends BaseAction<Role> {
	...
	public void afterToUpdate(Role role) {
		List<User> users = baseService.find(DetachedCriteria.forClass(User.class));
		List<Resource> resources = baseService.find(DetachedCriteria.forClass(Resource.class));
